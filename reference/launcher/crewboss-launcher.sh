...
# (GitHub-board, background-parallel, kill_switch flag at run/kill_switch).
# This file is kept because reference/tests/launcher-*.test.sh still run against it.
# DO NOT DELETE until tests are migrated to crewboss-launcher-gh.sh.
# See reference/runtime-manifest.tsv for the two-launchers decision.
#
